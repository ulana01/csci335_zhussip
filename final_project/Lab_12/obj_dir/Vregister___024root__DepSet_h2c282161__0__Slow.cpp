...
VL_ATTR_COLD void Vregister___024root___eval_initial__TOP(Vregister___024root* vlSelf);
...
VL_ATTR_COLD void Vregister___024root___eval_initial(Vregister___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vregister___024root___eval_initial__TOP(vlSelf);
...
VL_ATTR_COLD void Vregister___024root___eval_initial__TOP(Vregister___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vregister__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregister___024root___eval_initial__TOP\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body

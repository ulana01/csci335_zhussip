...
VL_INLINE_OPT void Valu___024root___ico_sequent__TOP__0(Valu___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.ALU_Result = (0xffffU & ((IData)(vlSelfRef.mode)
                                        ? ((8U & (IData)(vlSelfRef.ALU_Sel))
                                            ? ((4U 
                                                ...
                                                ? (
                                                   ...
                                                   ((1U 
                                                    ...
                                                    ((IData)(1U) 
                                                     + (IData)(vlSelfRef.A))
                                                     : 
                                                    VL_MODDIV_III(16, (IData)(vlSelfRef.A), (IData)(vlSelfRef.B))))
                                                : (
                                                   (2U 
                                                    & (IData)(vlSelfRef.ALU_Sel))
                                                    ? 
                                                   ((1U 
                                                    ...
                                                    ((0U 
                                                      != (IData)(vlSelfRef.B))
                                                      ? 
                                                     VL_DIV_III(16, (IData)(vlSelfRef.A), (IData)(vlSelfRef.B))
                                                      : 0xffffU)
                                                     : 
                                                    ((IData)(vlSelfRef.A) 
                                                     * (IData)(vlSelfRef.B)))
                                                   ...
                                                   ((1U 
                                                    ...
                                                    ((IData)(vlSelfRef.A) 
                                                     + (IData)(vlSelfRef.B))))))));
    vlSelfRef.Zero = (0U == (IData)(vlSelfRef.ALU_Result));
}

...
VL_INLINE_OPT void Vcontrol_unit___024root___nba_sequent__TOP__0(Vcontrol_unit___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*1:0*/ __Vdly__ControlUnit__DOT__state;
    __Vdly__ControlUnit__DOT__state = 0;
    // Body
    __Vdly__ControlUnit__DOT__state = vlSelfRef.ControlUnit__DOT__state;
    if (vlSelfRef.reset) {
        __Vdly__ControlUnit__DOT__state = 0U;
        vlSelfRef.done = 0U;
    } else if ((0U == (IData)(vlSelfRef.ControlUnit__DOT__state))) {
        ...
        __Vdly__ControlUnit__DOT__state = 1U;
    } else if ((1U == (IData)(vlSelfRef.ControlUnit__DOT__state))) {
        vlSelfRef.reg_enables = 2U;
        __Vdly__ControlUnit__DOT__state = 2U;
    } else if ((2U == (IData)(vlSelfRef.ControlUnit__DOT__state))) {
        vlSelfRef.done = 1U;
        __Vdly__ControlUnit__DOT__state = 0U;
    } else {
        __Vdly__ControlUnit__DOT__state = 0U;
    ...
    vlSelfRef.ControlUnit__DOT__state = __Vdly__ControlUnit__DOT__state;
}

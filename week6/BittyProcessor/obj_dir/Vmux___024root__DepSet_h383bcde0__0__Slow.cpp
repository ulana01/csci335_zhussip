...
VL_ATTR_COLD void Vmux___024root___ctor_var_reset(Vmux___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->data0 = VL_RAND_RESET_I(16);
    vlSelf->data1 = VL_RAND_RESET_I(16);
    vlSelf->data2 = VL_RAND_RESET_I(16);
    vlSelf->data3 = VL_RAND_RESET_I(16);
    vlSelf->data4 = VL_RAND_RESET_I(16);
    vlSelf->data5 = VL_RAND_RESET_I(16);
    vlSelf->data6 = VL_RAND_RESET_I(16);
    vlSelf->data7 = VL_RAND_RESET_I(16);
    vlSelf->data8 = VL_RAND_RESET_I(16);
    vlSelf->data9 = VL_RAND_RESET_I(16);
